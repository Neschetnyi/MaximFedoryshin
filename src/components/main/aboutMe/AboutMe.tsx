...
const AboutMe = () => {
  ...
  return (
    <section
      ...
      id="aboutMe"
      aria-label="about me"
      className=" flex flex-wrap  overflow-hidden backdrop-blur-2xl bg-black/10 min-h-lvh border-b-8 border-b-yellow-950/50"
    >
      <figure
        className={`MaximFoto w-1/3 p-5 flex flex-col  justify-around items-center overflow-hidden  `}
      >
        <div ref={myName.ref} className=" w-full h-px"></div>
        <figcaption>
          <strong
            className={`text-5xl inline-block font-['Engry',serif] font-bold text-green-50 transitionAll duration-1000 ${
      ...
      <div
        className={` w-2/3 p-5 text-green-50 transition-all duration-500 ${
