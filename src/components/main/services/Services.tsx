...
const Services = ({
  ...
  return (
    <section
      ref={services}
      id="services"
      className=" lg:w-[80lvw] w-lvw p-5  border-b-solid border-b-2 border-b-red-100/0 overflow-hidden"
      aria-label="services"
    >
        ...
        <div className="flex flex-col justify-around text-lg h-7/8">
          ...
          >
            <div>
              ...
              <br />
              <p>
                Работаю в формате психоаналитически терапии, опираясь на
                концепты ТФП-терапии и классические идеи детского психоанализа.
              </p>
            </div>
          </div>
